...
public abstract class Gramatica
{
	...
	{
		return ((0 <= numSimbolo) && (numSimbolo <= 10));
	}
	...
	{
		return ((11 <= numSimbolo) && (numSimbolo <= 16));
	}
	...
	{
		return ((17 <= numSimbolo) && (numSimbolo <= 16));
	}
