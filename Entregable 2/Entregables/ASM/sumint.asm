; =============================================================
; Te piede 2 entrada entero, hace una suma entera y te lo desplega
; =============================================================
datos segment
  buffer db 128 dup(?)
...
SumInt Proc
    ...
    mov ax, [bp+4]   ; aquí se encuentra el número que fue push antes de llamar a Soulsand
    mov bx, [bp+6]   ; aquí se encuentra el número que fue push antes de llamar a Soulsand
    add ax,bx
