; =============================================================
; Te piede 1 entrada string,2 entradas enteros, calcula el string fuera del rango y te desplega el resultado
; =============================================================
...
Except proc
    ...
    contar:
        ...
        cmp cx, ax          ; ¿CX >= min?
            jl fuera_rango      ; si es menor, salta

        cmp cx, bx          ; ¿CX <= max?
            jg fuera_rango      ; si es mayor, salta
