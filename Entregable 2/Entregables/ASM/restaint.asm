; =============================================================
; Te piede 2 entrada entero, hace una resta entera y te lo desplega
; =============================================================
datos segment
  buffer db 128 dup(?)
  signo dw 0
...
RestaInt Proc
    ...
    ; Recuperar el parámetro de la pila
    mov ax, [bp+6]   ; aquí se encuentra el número que fue push antes de llamar a Soulsand
    mov bx, [bp+4]   ; aquí se encuentra el número que fue push antes de llamar a Soulsand
    sub ax,bx
